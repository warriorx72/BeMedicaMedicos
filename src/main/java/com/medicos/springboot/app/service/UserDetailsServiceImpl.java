...
//	}
	...
	public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {
		com.medicos.springboot.app.models.entity.User appUser = repository.findByEmail(email).orElseThrow(() -> new UsernameNotFoundException("Login username or email ivalidos"));
