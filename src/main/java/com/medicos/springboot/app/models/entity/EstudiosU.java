...
@Entity
@Table(name="estudios")
public class EstudiosU implements Serializable{
	...
	public String getEstudioPrecio() {
		return EstudioPrecio;
	}

	public void setEstudioPrecio(String estudioPrecio) {
